...
public class Recommendation3_Helper {
	private static final int TARGET_CLUSTERS = 10;
	private static final int IDEAL_CLUSTERS = 20;
	...
	public static HashMap<Integer, Set<String>> getBusinessCluster(String type) {
		...
		String idealCluster = "/Users/haowang/Desktop/CS512_Project/business_cluster_hard_pure_user.txt";
		...
		// System.out.println(businessCluster.keySet());
	...
	public static HashMap<String, Double> businessScoreInCluster(int cluster, String type) {
		...
		for(String businessId : business_in_cluster) {
			//use checkin numbers to represent p(b|c')
			double score = 0.0;

			if(checkInCounts.containsKey(businessId)) {
				score = checkInCounts.get(businessId) + 0.0;
			}
